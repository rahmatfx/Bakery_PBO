...
from Constant import SCREEN_WIDTH, SCREEN_HEIGHT, CASHIER_BG, COLOR_BG_CREAM, COLOR_DARK_BROWN, FONT_HEADING_SIZE, FONT_BODY_SIZE, FONT_NAME
...
class Cashier(Room):
    ...
    def enter(self):
        if os.path.exists(CASHIER_BG):
            self._bg_image = pygame.transform.smoothscale(
                pygame.image.load(CASHIER_BG).convert(), (SCREEN_WIDTH, SCREEN_HEIGHT))
